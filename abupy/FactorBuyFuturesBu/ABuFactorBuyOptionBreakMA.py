...
class AbuFactorBuyOptionBreakMA(AbuFactorBuyFuturesBase, BuyCallMixin):
    ...
    def fit_day(self, today, holding_object):
        ...
        if signal:
            ...
            if len(self.option_list) > 32:
                ...
                option.clear_price = self.option_clear_price
...
# noinspection PyAttributeOutsideInit
class AbuFactorBuyPutOptionBreakMA(AbuFactorBuyFuturesBase, BuyPutMixin):
