...
class AbuFuturesCn(FreezeAttrMixin):
    ...
    def query_contract_multiplier(self, symbol):
        """
        国内期货查询一手单位
        :param symbol: 期货字符串对象
        :return:
        """
    ...
    # noinspection PyMethodMayBeStatic
    def query_contract_tick(self, symbol):
        """
        国内期货查询tick size
        :param symbol: 期货字符串对象
        :return:
        """
        tick = ABuEnv.g_futures_cn_info_dict['tick_size'][get_letters(symbol)]
        return tick
