...
class AbuFactorSellBreakMAClosePut(AbuFactorSellFuturesBase):
    """到期平仓卖出因子"""
    ...
    def fit_day(self, today, holding_cnt, orders, buy_factor):
        ...
        # condition = today.close > self.ma_line[today_ind - self.xd + 1:today_ind + 1].min()
